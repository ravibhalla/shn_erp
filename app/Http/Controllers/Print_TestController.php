...
class Print_TestController extends Controller
{
    ...
    public function test_product_data($test_id){
        ...
        etp.test_gen_id,etp.client_id,etp.status,etp.product_name as product_name,etp.product_img_url,etp.booking_date,etp.due_date,etp.letter_ref_no,etm.test_method as test_method,etp.letter_date,etp.description,etp.letter_img_url,etp.total_amt,etp.advc_amount,etp.inserted_time,ec.name as client_name,ec.email as email,ec.address as client_address,ec.gst_no as client_gst,tdu.id as test_util_id,tdu.is_done,tp.name as param_name,tp.price
